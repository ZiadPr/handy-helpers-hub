    ...
    <footer className="mt-24 bg-primary text-primary-foreground">
      <div className="container py-14 grid gap-10 md:grid-cols-4">
        <div className="space-y-4">
          ...
          <p className="text-sm text-primary-foreground/70 leading-relaxed">{t.footer.aboutDesc}</p>
          <div className="flex gap-2">
            {[Facebook, Instagram, Twitter].map((Icon, i) => (
              <a
                key={i}
                href="#"
                className="h-9 w-9 rounded-full bg-primary-foreground/10 hover:bg-gold hover:text-primary grid place-items-center transition-colors"
              >
        ...
        <div>
          ...
          <div className="space-y-2">
            <a href="#" className="flex items-center gap-2 rounded-lg border border-primary-foreground/20 px-3 py-2 hover:border-gold hover:text-gold transition-colors">
